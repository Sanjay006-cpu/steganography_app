...
class PasswordDialog(QDialog):
    ...
    def generate_password(self):
        ...
        strength_text = {0: "Very Weak", 1: "Weak", 2: "Fair", 3: "Good", 4: "Strong"}
...
class SteganographyApp(QWidget):
    def __init__(self):
        ...
        self.output_file = ""
        self.max_chars = 0
        self.dummy_key = base64.urlsafe_b64encode(b'0' * 32)
        self.dummy_fernet = Fernet(self.dummy_key)
        self.password = None  # To store generated password
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.custom_password_radio = QRadioButton("Password Generate")
        ...
        # Wrap the password layout in a QWidget
        self.password_widget = QWidget()
        self.password_widget.setLayout(self.password_layout)
        main_layout.addWidget(self.password_widget)  # Add widget instead of layout
        ...
        try:
            if self.action == "encode":
                ...
                if self.auto_key_radio.isChecked():
                    ...
                    self.password = None  # Reset after use

            else:  # Decode
                if not rate_limiter.can_attempt():
                    remaining = int(rate_limiter.lockout_time - (time.time() - max(rate_limiter.attempts, default=0)))
